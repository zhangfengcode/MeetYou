...
+ (UIBarButtonItem *)mh_svgBarButtonItem:(nonnull NSString *)imageName targetSize:(CGSize)size tintColor:(UIColor *)tintColor target:(id)target selector:(SEL)selector {
    ...
    return [[UIBarButtonItem alloc] initWithImage:[UIImage mh_svgImageNamed:imageName targetSize:size tintColor:tintColor?tintColor:[UIColor grayColor]] style:UIBarButtonItemStylePlain target:target action:selector];
}
