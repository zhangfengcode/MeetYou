...
/// 获取系统颜色
static inline UIColor * _Nullable MHBarButtonItemTitleColor(BOOL useSystem) {
    return useSystem ? [UIColor systemGrayColor]: [UIColor systemGrayColor];
}
 ...
 */
+ (UIBarButtonItem *_Nullable)mh_systemItemWithTitle:(NSString *)title
