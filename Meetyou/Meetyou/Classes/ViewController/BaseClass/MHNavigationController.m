...
- (void)_setupNavigationBarBottomLine{
    ...
    UIImageView *navSystemLine = [[UIImageView alloc] initWithFrame:CGRectMake(0, self.navigationBar.height - navSystemLineH, MH_SCREEN_WIDTH, navSystemLineH)];
    // v7.0.0-
...
+ (void) _setupNavigationBarTheme{
    ...
    // 设置导航栏的背景渲染色
    [appearance setBarTintColor:[[UIColor orangeColor] colorWithAlphaComponent:0.65]];
...
+ (void)_setupBarButtonItemTheme{
    ...
    highTextAttrs[NSForegroundColorAttributeName] = [[UIColor orangeColor] colorWithAlphaComponent:.5f];
    [appearance setTitleTextAttributes:highTextAttrs forState:UIControlStateHighlighted];

    // 设置不可用状态(disable)的文字属性
    NSMutableDictionary *disableTextAttrs = [NSMutableDictionary dictionaryWithDictionary:textAttrs];
    disableTextAttrs[NSForegroundColorAttributeName] = [[UIColor grayColor] colorWithAlphaComponent:.5f];
