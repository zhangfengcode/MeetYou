...
static inline NSString *MHWeChatDocDirPath(){
    return [MHDocumentDirectory stringByAppendingPathComponent:MH_MEETYOU_DOC_NAME];
}
...
static inline NSString *MHWeChatCacheDirPath(){
    return [MHCachesDirectory stringByAppendingPathComponent:MH_MEETYOU_CACHE_NAME];
}
