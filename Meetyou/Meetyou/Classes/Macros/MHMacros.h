...
/// 微信项目重要数据备份的文件夹名称（Documents/MeetyouDoc）利用NSFileManager来访问
#define MH_MEETYOU_DOC_NAME  @"MeetYou"

/// 微信项目轻量数据数据备份的文件夹（Library/Caches/MeetyouCache）利用NSFileManager来访问
#define MH_MEETYOU_CACHE_NAME  @"MeetYouCache"
