...
//
    ...
    self.divider0.frame = CGRectMake(0, 0, self.width, MHGlobalBottomLineHeight);
    self.divider1.frame = CGRectMake(self.textLabel.x, self.height-MHGlobalBottomLineHeight, self.width-14, MHGlobalBottomLineHeight);
    self.divider2.frame = CGRectMake(0, self.height-MHGlobalBottomLineHeight, self.width, MHGlobalBottomLineHeight);
    
    /// 设置头像
    self.avatarView.size = CGSizeMake(66, 66);
    self.avatarView.height = self.accessoryView.left - 7;
